...
class DepartmentSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            [
                'code' => 'finance',
                'name_ar' => 'الأمانة المالية',
                'name_fr' => 'Secrétariat financier',
                'sort_order' => 35,
                'officer_name_ar' => 'يُعلن لاحقاً',
                'officer_name_fr' => 'À annoncer',
                'officer_title_ar' => 'أمين الأمانة المالية',
                'officer_title_fr' => 'Secrétaire financier',
                'officer_bio_ar' => 'يشرف على الاشتراكات والمصروفات والتقارير المالية للرابطة.',
                'officer_bio_fr' => 'Supervise les cotisations, les dépenses et les rapports financiers de la Rabta.',
                'officer_email' => 'finance@acs-rennes.fr',
            ],
            [
                'code' => 'media',
        ...
        foreach ($items as $item) {
            ...
            $deputyTitles = [
                ...
                'finance' => ['نائب أمين الأمانة المالية', 'Vice-secrétaire financier', 'finance@acs-rennes.fr'],
