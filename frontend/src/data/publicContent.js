...
export const newsItems = [
  {
    ...
    date: '2026-08-01',
    title: { ar: 'انطلاق السنة الأكاديمية 2026/2027', fr: 'Lancement de l’année académique 2026/2027' },
    excerpt: {
  ...
  },
  {
    ...
    date: '2026-03-20',
    title: { ar: 'حملة تضامنية رمضانية', fr: 'Campagne de solidarité du Ramadan' },
    excerpt: {
  ...
  },
  {
    ...
    date: '2026-05-12',
    title: { ar: 'يوم ثقافي سوداني في رين', fr: 'Journée culturelle soudanaise à Rennes' },
    excerpt: {
  ...
  },
  {
    ...
    date: '2026-07-05',
    title: { ar: 'انطلاق البرنامج الصيفي للأطفال', fr: 'Lancement du programme d’été pour enfants' },
    excerpt: {
...
export const upcomingEvents = [
  {
    ...
    title: { ar: 'الجمعية العمومية السنوية', fr: 'Assemblée générale annuelle' },
    date: '2026-09-14',
    time: '15:00',
    place: { ar: 'رين — قاعة الاجتماعات', fr: 'Rennes — salle de réunion' },
    organizer: { ar: 'الأمانة العامة', fr: 'Secrétariat général' },
    summary: {
  ...
  },
  {
    ...
    title: { ar: 'ورشة دعم اللغة العربية', fr: 'Atelier de soutien en langue arabe' },
    date: '2026-09-21',
    time: '10:00',
    place: { ar: 'المقر الأكاديمي', fr: 'Siège académique' },
    organizer: { ar: 'الأمانة الأكاديمية', fr: 'Secrétariat académique' },
    summary: {
  ...
  },
  {
    ...
    title: { ar: 'لقاء مع شركاء محليين', fr: 'Rencontre avec des partenaires locaux' },
    date: '2026-10-03',
    time: '17:00',
    place: { ar: 'رين', fr: 'Rennes' },
    organizer: { ar: 'الأمانة الخارجية', fr: 'Relations extérieures' },
    summary: {
...
export const galleryAlbums = [
  {
    ...
    title: { ar: 'فعاليات رمضان 2026', fr: 'Événements du Ramadan 2026' },
  },
  {
